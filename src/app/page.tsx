            ...
            {!trendsData ? (
              ...
              <>
                ...
                {(() => {
                  ...
                  const lowQualityDays = last7.filter((d: any) => d.sleep?.quality != null && d.sleep.quality < 5);
                  if (lowQualityDays.length >= 4) { const avgQ = Math.round(lowQualityDays.reduce((s: number, d: any) => s + d.sleep.quality, 0) / lowQualityDays.length); obs.push({ emoji: "😔", label: "Low Sleep Quality", text: `${lowQualityDays.length} of last 7 nights quality < 5/10 (avg ${avgQ}/10). Consider: earlier bedtime, no screens before bed, cooler room.`, color: "orange" }); }
